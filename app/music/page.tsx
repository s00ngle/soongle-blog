...
const SkeletonCard = () => (
  <div className="bg-white rounded-xl overflow-hidden shadow-lg">
    ...
    <div className="p-4 space-y-3">
      <div className="h-6 bg-gray-200 rounded-sm animate-pulse w-3/4" />
      <div className="space-y-2">
        <div className="h-4 bg-gray-200 rounded-sm animate-pulse" />
        <div className="h-4 bg-gray-200 rounded-sm animate-pulse w-5/6" />
      </div>
      <div className="h-3 bg-gray-200 rounded-sm animate-pulse w-1/4" />
    </div>
  </div>
);
